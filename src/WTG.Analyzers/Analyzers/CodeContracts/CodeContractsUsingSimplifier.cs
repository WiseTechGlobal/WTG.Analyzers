...
namespace WTG.Analyzers
{
	sealed class CodeContractsUsingSimplifier : CSharpSyntaxRewriter
	{
		...
		{
			if (!node.HasAnnotation(Simplifier.Annotation) && node.Name != null && (node.Name.IsMatch("System.Diagnostics.Contracts") || node.Name.IsMatch("System.Diagnostics.CodeAnalysis")))
			{
